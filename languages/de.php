...
$lang[10]       =       'Datei <b>%1$s</b> (<b>%2$s</b>) gespeichert!<br />Zeit: <b>%3$s</b><br />Durchschnittsgeschwindigkeit: <b>%4$s KB/s</b><br />';        // %1$s = Dateiname %2$s = Dateigr�sse %3$s = time of download %4$s = geschwindigkeit
...
$lang[18]       =       '%1$s Links &uuml;berpr&uuml;ft in %3$s Sekunden. (Methode: <b>%4$s</b>)';      // %1$s = Nummer von links %2$s = Plural form %3$s = seconds %4$s = methode zum links �berpr�fen
...
$lang[76]       =       '<div class="linktitle">Lade Link hoch zu <strong>%1$s</strong> - <span class="bluefont">Gr&ouml;sse: <strong>%2$s</strong></span></div>';      // %1$s = Datei name %2$s = Datei Gr�sse
$lang[77]       =       'ERLEDIGT';
$lang[78]       =       'Zur&uuml;ck';
...
$lang[123]      =       'In %1$s Teile splitten';      // %1$s = part Gr�sse
$lang[124]      =       'Methode';
