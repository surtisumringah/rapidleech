...
/* # Plugin's Settings # */
$_T8['domain'] = 'maknyos.indowebster.com'; // May require the www. (Check first if the site adds the www.).
$_T8['anonUploadDisable'] = false; // Disallow non-registered users upload. (XFS Pro)
$_T8['anonUploadLimit'] = 128; // File-size limit for non-registered users (MB) | 0 = Plugin's limit | (XFS Pro)
...
// Advanced Settings (Don't edit it unless you know what are you doing)
	...
	$_T8['opUploadName'] = 'upload_files'; // Custom ?op=value for checking upload page, default: 'upload'
...
// Written by Th3-822 (Finally, a plugin for IDWS that works fine)
