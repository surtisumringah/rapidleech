...
/* # Plugin's Settings # */
$_T8['domain'] = 'uploadocean.com'; // May require the www. (Check first if the site adds the www.).
$_T8['anonUploadDisable'] = false; // Disallow non-registered users upload. (XFS Pro)
$_T8['anonUploadLimit'] = 4096; // File-size limit for non-registered users (MB) | 0 = Plugin's limit | (XFS Pro)
...
//[22-03-2017] Written by The Devil
